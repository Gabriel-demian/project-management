...
//	ProjectRepository projRepo;
	...
	// We use the following method since using a table in memory every time we run it restarts. In this way, 
	// when starting the application, the tables are loaded with the information
//	@Bean
